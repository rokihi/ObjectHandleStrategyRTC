...
#ifndef WIN32
  #warning "Code missing in function <Manipulation::ReturnValue* Manipulation_ObjectDetectionServiceSVC_impl::detectObject(const Manipulation::ObjectIdentifier& objectID, Manipulation::ObjectInfo_out objInfo)>"
#endif
  return result;
}
...
Manipulation::ReturnValue* Manipulation_ObjectDetectionServiceSVC_impl::setBaseFrame(const Manipulation::Matrix34 frame)
{
  ...
  // Please insert your code here and remove the following warning pragma
#ifndef WIN32
  #warning "Code missing in function <Manipulation::ReturnValue* Manipulation_ObjectDetectionServiceSVC_impl::setBaseFrame(const Manipulation::Matrix34 frame)>"
#endif
  return result;
}
...
Manipulation::ReturnValue* Manipulation_ObjectHandleStrategyServiceSVC_impl::getApproachOrientation(const Manipulation::ObjectInfo& objInfo, Manipulation::EndEffectorPose& eePos)
{
  ...
  // Please insert your code here and remove the following warning pragma
#ifndef WIN32
  #warning "Code missing in function <Manipulation::ReturnValue* Manipulation_ObjectHandleStrategyServiceSVC_impl::getApproachOrientation(const Manipulation::ObjectInfo& objInfo, Manipulation::EndEffectorPose& eePos)>"
#endif
  return result;
}
...
Manipulation::ReturnValue* Manipulation_KinematicSolverServiceSVC_impl::solveKinematics(const Manipulation::EndEffectorPose& targetPose, const Manipulation::JointAngleSeq& startJointAngles, Manipulation::JointAngleSeq_out targetJointAngles)
{
  ...
  // Please insert your code here and remove the following warning pragma
#ifndef WIN32
  #warning "Code missing in function <Manipulation::ReturnValue* Manipulation_KinematicSolverServiceSVC_impl::solveKinematics(const Manipulation::EndEffectorPose& targetPose, const Manipulation::JointAngleSeq& startJointAngles, Manipulation::JointAngleSeq_out targetJointAngles)>"
#endif
  return result;
}
...
Manipulation::ReturnValue* Manipulation_CollisionDetectionServiceSVC_impl::isCollide(const Manipulation::RobotIdentifier& robotID, const Manipulation::JointAngleSeq& jointAngles, Manipulation::CollisionPairSeq_out collisions)
{
  ...
  // Please insert your code here and remove the following warning pragma
#ifndef WIN32
  #warning "Code missing in function <Manipulation::ReturnValue* Manipulation_CollisionDetectionServiceSVC_impl::isCollide(const Manipulation::RobotIdentifier& robotID, const Manipulation::JointAngleSeq& jointAngles, Manipulation::CollisionPairSeq_out collisions)>"
#endif
  return result;
}
...
Manipulation::ReturnValue* Manipulation_ModelServerServiceSVC_impl::getModelInfo(const Manipulation::RobotIdentifier& robotID, Manipulation::RobotJointInfo_out jointsInfo)
{
  ...
  // Please insert your code here and remove the following warning pragma
#ifndef WIN32
  #warning "Code missing in function <Manipulation::ReturnValue* Manipulation_ModelServerServiceSVC_impl::getModelInfo(const Manipulation::RobotIdentifier& robotID, Manipulation::RobotJointInfo_out jointsInfo)>"
#endif
  return result;
}
